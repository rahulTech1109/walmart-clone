...
function Header() {
    ...
    return (
        <header className="flex flex-col md:flex-row items-center bg-[#0171dc] px-10 py-7 space-x-5 ">
            <Link href="/" className="mb-5 md:mb-0">
                <Image
                    className="bg-white"
                    src="https://purepng.com/public/uploads/medium/purepng.com-walmart-logologobrand-logoiconslogos-251519939045xswix.png"
                    alt="Logo"
                    width={150}
                    height={150}
                />
